...
# Function aliases to match expected import names
generate_simple_tags = generate_tags_from_sections
generate_csi_tags = generate_detailed_tags
get_tag_name_for_section = get_tag_for_section
get_all_csi_tag_options = get_all_tag_options
